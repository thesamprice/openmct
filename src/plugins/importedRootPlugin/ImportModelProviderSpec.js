define([
    './ImportModelProvider',
    'text!./import-provider-test.json'
], function (
    ImportModelProvider,
    testImportDataText
) {

    describe('ImportModelProvider', function () {

        var importProvider;

        beforeEach(function () {
            var importData = JSON.parse(testImportDataText);
            importProvider = new ImportModelProvider(importData, {
                namespace: 'my-import',
                key: 'root'
            });
        });
        ...
        describe('childObjects', function () {
            ...
            beforeEach(function () {
                swg = importProvider.get({
                    namespace: 'my-import',
                    key: '1'
                });
                layout = importProvider.get({
                    namespace: 'my-import',
                    key: '2'
                });
                fixed = importProvider.get({
                    namespace: 'my-import',
                    key: '3'
                });
            });
